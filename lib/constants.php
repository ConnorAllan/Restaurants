<?php
define('DATABASE_NAME', strtoupper(get_current_user()) . '_resturants');
define('DATABASE_READER', get_current_user() .'_reader');

define('DATABASE_READER_PWD', 'r');
define('DATABASE_WRITER_PWD', 'w');
define('DATABASE_WRITER', get_current_user() .'_writer');
...
// sanatize POST global variables
if (!empty($_POST)) {
...
if (DEBUG) {
    ...
    print '<p>DATABASE NAME: ' . DATABASE_NAME;
    print '<p>DATABASE_READER: ' . DATABASE_READER;
    print '<p>DATABASE_WRITER: ' . DATABASE_WRITER;
}
?>
